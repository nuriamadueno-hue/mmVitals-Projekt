...
def build_combined_arg_parser():
    ...
    p.add_argument("--rate-trend-window-s", type=float, default=15.0, help="Sliding-window length in seconds for the validation plot showing breathing/heart rate over time. Default: 15 s.")
    p.add_argument("--rate-trend-step-s", type=float, default=1.0, help="Step size in seconds for the validation rate-trend plot. Default: 1 s.")
